...
class Paint(object):
    ...
    def __init__(self):
        self.root = Tk()
        title = Label(self.root, text="PAINT", font=('times new roman', 30, 'bold'), fg="Black", relief=GROOVE)
        title.pack(fill=X)
        ...
        self.c = Canvas(self.root, bg='white', width=1350, height=750,relief=RIDGE,borderwidth=0)
